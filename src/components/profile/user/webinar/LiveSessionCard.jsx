...
const LiveSessionCard = ({ className }) => {
  return (
    <Card
      className={cn("border-2 border-gray-300 bg-white md:w-full", className)}
    >
      <CardContent className="p-6">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div className="flex-1">
            <div className="mb-4 flex items-center gap-4">
              <Badge className="bg-red-600 px-3 py-1 font-medium text-white hover:bg-red-600">
